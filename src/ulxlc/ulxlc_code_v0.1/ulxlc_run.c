...
void print_params(double *params, int nparam){
...
int main(int argc, char *argv[]){
	...
	// ULXLC parameters	
	double params[7];
	params[0] =	atof(argv[1]);	// period
	params[1] =	atof(argv[2]);	// phase
	params[2] =	atof(argv[3]);	// theta
	params[3] =	atof(argv[4]);	// incl
	params[4] =	atof(argv[5]);	// dincl
	params[5] = atof(argv[6]);	// beta
	params[6] = atof(argv[7]);	// dopulse
	
	// print_params(params, 7);
