...
def main():
    ...
    curve_classifications = pd.DataFrame(results, columns=['system_id', 'theta', 'dincl', 'inclination', 'lc_min', 'lc_max', 'N_lim', 'classification'])
    curve_classifications.to_csv('../data/processed/curve_classifications.csv', index=False)
