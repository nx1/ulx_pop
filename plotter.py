...
#            print('Found system of inclination:', inclination)
            time = curves[key]['Time']
            flux = curves[key]['Flux']
...
# =============================================================================
# Looping over all curve files to get averages
# =============================================================================
...
# =============================================================================
# Putting into pandas df Looping over all curve files to get averages
# =============================================================================
...
pivot = pd.pivot_table(df_a_nonzero, index =['curve_num', 'dincl'] , aggfunc=('count', 'mean', 'std'))

for index, mean in zip(pivot.index, pivot[('ratio', 'mean')]):
    plt.scatter(index[1], mean, label = index[0])
